...
public class MalletCategorizer {
  ...
  public static void main(String[] args) throws Exception {
    ...
    pipeList.add(new TokenSequenceRemoveStopwords(new File("stopwords.txt"),
    ...
    Reader fileReader = new InputStreamReader(
        new FileInputStream(new File("ap.txt")), "UTF-8");
    ...
    while (iterator.hasNext() && rank < 5) {
      IDSorter idCountPair = iterator.next();
      topicZeroText
          .append(dataAlphabet.lookupObject(idCountPair.getID()) + " ");
      rank++;
    }
    ...
    testing.addThruPipe(
        new Instance(topicZeroText.toString(), null, "test instance", null));
